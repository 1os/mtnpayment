...
/**
 * mtn enrolment plugin - support for user self unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'mtnpayment'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/mtnpayment/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_mtnpayment', format_string($course->fullname));
